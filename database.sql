...
--
-- Host: 127.0.0.1:3306
-- Tempo de geração: 22/10/2025 às 17:33
...
--
-- Banco de dados: `u525422670_Obetzera123`
--
...
(1, '/assets/banners/baner1.png', 1, 1),
(2, '/assets/banners/baner2.png', 1, 2);
...
(1, 'RASPA MONKEY', '/assets/upload/689ac97dbe1a6.png', 10, 10, 10, 0);
...
CREATE TABLE `gateway` (
  ...
  `active` enum('ondapay') DEFAULT 'ondapay',
...
(1, 'https://api.ondapay.app', 'xxxxxxxxxxxxxxxxxxxx', 'xxxxxxxxxxxxxxxxxxxx', '2025-07-19 12:56:52', '2025-10-22 17:32:11');
...
CREATE TABLE `orders` (
  ...
  `resultado` enum('loss','gain') CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci DEFAULT NULL,
...
(1, 'SONHO PREMIADO - R$ 2,00 - PRÊMIOS DE ATÉ R$5.000,00 ', 'Com só R$2, você raspa e pode levar prêmios exclusivos, gadgets, ou R$5000 na conta.', '/assets/img/banners/1687ce7f33afe8.png', 2.00, '2025-07-11 21:55:04'),
(2, 'MEGA RASPADA BLACK 🖤💰 - R$10,00 - PRÊMIOS DE ATÉ R$20.000,00', 'Com R$10 na raspada você ativa a chance de faturar uma bolada até R$20.000. Prêmio bruto, imediato.', '/assets/img/banners/1687ce824a04ed.png', 10.00, '2025-07-11 21:55:04'),
(3, '🔥 PIX TURBINADO - R$ 1,00 - PRÊMIOS DE ATÉ R$2.500,00', 'Raspa por apenas R$1 e pode explodir até R$2500 direto no PIX.', '/assets/img/banners/1687ce7af59f64.png', 1.00, '2025-07-16 19:19:31'),
(4, 'OSTENTAÇÃO INSTANTÂNEA 💎 - R$5,00 - PRÊMIOS DE ATÉ R$10.000,00', 'R$5 pra raspar e a chance real de garantir eletrônicos top ou até R$10.000 em PIX.', '/assets/img/banners/1687cea40caafd.png', 5.00, '2025-07-19 18:07:00');
...
CREATE TABLE `saques` (
  ...
  `gateway` varchar(50) DEFAULT 'ondapay',
  `webhook_data` text DEFAULT NULL,
...
(1, 'Obetzera', '(11) 94002-8922', 'admin@obetzera.com', '$2y$10$hXuGGAHgQX0BO4sNfO//4eRFeS432teEvs306iby.UQN6bsKK0z5e', 100.00, '', 10, 0, 0, 1, '2025-10-22 17:27:28', '2025-10-22 17:33:46', 0);
